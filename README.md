...
### 🎮 게임 (5개)
- **이상형 월드컵** - 토너먼트 대결 게임
- **밸런스 게임** - 양자택일 질문 게임 (36개 질문)
- **초성 퀴즈** - 한글 초성 맞추기 (4개 카테고리)
- **사다리 게임** - 공정한 추첨용 사다리타기
- **빙고 게임** - 호스트/플레이어 모드 빙고

### 🔧 유틸리티 (7개)
- **실시간 투표** - QR 코드 투표 (3가지 유형)
- **랜덤 뽑기** - 암호학적으로 안전한 룰렛
- **팀 나누기** - Fisher-Yates 알고리즘 팀 분배
- **점심 룰렛** - Kakao Maps 기반 맛집 추천
- **단체 주문** - 실시간 주문 집계 시스템
- **신분증 검증기** - 주민번호/사업자/법인번호 검증
- **수강생 네트워킹** - 관심사 기반 학생 매칭
