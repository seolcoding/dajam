...
import type { Participant, TeamSettings } from '@/app/team-divider/types/team';
import { divideIntoTeams } from '@/app/team-divider/utils/shuffle';
import { generateAllQRCodes } from '@/app/team-divider/utils/qrcode';
